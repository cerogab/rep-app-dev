...
import { useTheme, useColors, ThemeName } from '@/lib/theme-context';
...
export default function AppearanceScreen() {
  ...
  const toggleBlueOrange = () => {
    Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
    setSelectedTheme('blueOrange');
  };
      ...
      <View style={styles.content}>
        ...
        <View style={[styles.card, { backgroundColor: colors.white }]}>
          <View style={[styles.row, { borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: colors.border }]}>
            <Text style={[styles.rowLabel, { color: colors.text }]}>Orange Theme</Text>
            <Switch
              value={selectedTheme === 'orange'}
              onValueChange={toggleOrange}
          ...
          <View style={styles.row}>
            <Text style={[styles.rowLabel, { color: colors.text }]}>Blue Orange Theme</Text>
            <Switch
              value={selectedTheme === 'blueOrange'}
              onValueChange={toggleBlueOrange}
              trackColor={{ false: colors.border, true: colors.primary }}
              thumbColor={colors.white}
              ios_backgroundColor={colors.border}
            />
